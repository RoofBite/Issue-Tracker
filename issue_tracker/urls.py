...
urlpatterns = [
    ...
    path("manage-project-details/<int:pk>/", views.manage_project_details, name="manage-project-details"),
    path("manage-project-developers/<int:pk>/", views.manage_project_developers, name="manage-project-developers"),
    path("add-issue/", login_required(views.Add_issue.as_view()), name="add-issue"),
    path("update-issue/<int:pk>/", login_required(views.Update_issue.as_view()), name="update-issue"),
