...
class TestView_project_details_old_issues(TestCase):
    def setUp(self):
        ...
        self.issue = Issue.objects.create(
            title="Issue1", creator=self.user, project=self.project, status="CLOSED"
        )
        self.issue2 = Issue.objects.create(
            title="Issue2", creator=self.user, project=self.project, status="RESOLVED"
        )

    def test_project_details_old_issues_leader_group_user_GET_allowed(self):
        group = Group.objects.get(name="leader")
        group.user_set.add(self.user)
    ...
    def test_project_details_old_issues_admin_group_user_GET_allowed(self):
        group = Group.objects.get(name="admin")
        group.user_set.add(self.user)
    ...
    def test_project_details_old_issues_leader_group_user_GET_not_allowed(self):
        group = Group.objects.get(name="leader")
        group.user_set.add(self.user)
...
class TestView_project_developer_resign(TestCase):
    ...
    def test_project_developer_resign_developer_group_user_GET_not_allowed(self):
        group = Group.objects.get(name="developer")
        group.user_set.add(self.user)
...
class TestView_project_details(TestCase):
    ...
    def test_project_details_leader_group_user_GET_allowed(self):
        group = Group.objects.get(name="leader")
        group.user_set.add(self.user)
    ...
    def test_project_details_admin_group_user_GET_allowed(self):
        group = Group.objects.get(name="admin")
        group.user_set.add(self.user)
    ...
    def test_project_details_leader_group_user_GET_not_allowed(self):
        group = Group.objects.get(name="leader")
        group.user_set.add(self.user)
...
class TestView_issue_details(TestCase):
    def setUp(self):
        self.superuser = User.objects.create_superuser(
            "Superuser", "Superuser@example.com", "Password"
        )
    ...
    def test_issue_details_developer_group_user_GET_allowed(self):
        group = Group.objects.get(name="developer")
        group.user_set.add(self.user)

        self.client.force_login(user=self.user, backend=None)
        response = self.client.get(
            reverse("issue_tracker:issue-details", args=["1"]),
            {"search_query": "Project"},
        )

        self.assertEquals(response.status_code, 200)

    def test_issue_details_admin_group_user_GET_allowed(self):
        group = Group.objects.get(name="admin")
        group.user_set.add(self.user)
    ...
    def test_issue_details_leader_group_user_GET_not_allowed(self):
        group = Group.objects.get(name="leader")
        group.user_set.add(self.user)

        self.client.force_login(user=self.user, backend=None)
        response = self.client.get(
            reverse("issue_tracker:issue-details", args=["2"]),
            {"search_query": "Project"},
        )
